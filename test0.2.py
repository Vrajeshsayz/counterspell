...
pygame.display.set_caption("Shadow Duel")
...
play_again_button = Button("Play Again", (400, 300), (300, 50))
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if game_state == "win" and play_again_button.is_hovered(mouse_pos):
                reset_game()
                game_state = "game"  # Reset to game state
                ...
                if fight_button.is_hovered(event.pos):
